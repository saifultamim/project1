...
const AdminFooter = () => {
    return (
        <footer className='w-10/12 mx-auto px-4 sm:px-6 lg:px-8 grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 justify-between text-lg jaro py-8 text-white'>
            <Link href='/' className='flex items-center gap-1'>
            <Image src={logo} alt='logo' width={100} height={100} className='w-16 h-16'/>
            <p>Xenon</p>
            </Link>
            <div>
                <p className='text-xl'>Explore Xenon</p>
